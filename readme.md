...
- **纯前端实现**：使用 HTML/CSS/JavaScript 创建单页应用
- **离线可用**：无需联网，数据存储在本地（localStorage）
- **浏览器即可使用**：无需安装任何软件
...
随机点名、九宫格抽奖、批量操作等实用工具，让课堂管理更有趣，学生参与度提升

- 随机点名：支持单人/多人点名、动画效果、历史记录、可设置点名概率权重
- 九宫格抽奖：自定义奖品设置、库存管理、抽奖速度调节、中奖记录
- 批量操作：批量加减分、一次选择多个学生
...
- **九宫格抽奖**：节日活动、期末总结用抽奖激励，仪式感满满，学生超期待
